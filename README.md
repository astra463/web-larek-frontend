...
<p style="color: darkblue">*P.S. Для ревьюера*
...
*Также я не знаю, верно ли у меня реализован рендеринг карточек товара и других модальных окон, поэтому я решил отправить работу на первый этап ревью сейчас в надежде получить корректировки к работе.* </p>
